 ...
 *
 */
public interface Postgres10PlusDdlConstants extends DdlConstants {
	public static final String[] CUSTOM_KEYWORDS = {
        ...
        "LINE", "LSEG", "MACADDR", "MACADDR8", "MONEY", "PATH", "POINT", "POLYGON",
        "SERIAL", "SERIAL4", "SERIAL8", "TEXT", "TIMESTAMPZ", "TSQUERY",
        "TSVECTOR", "TXID_SNAPSHOT", "UUID", "XML", "OID", "TIMESTAMPTZ", "TSTZRANGE", "PARTITION"
	};
	...
	interface PostgresStatementStartPhrases {
	    ...
	    public final static String[] VALID_SCHEMA_CHILD_STMTS = {
	    	...
	    	Postgres10PlusDdlLexicon.TYPE_CREATE_INDEX_STATEMENT,
	    	Postgres10PlusDdlLexicon.TYPE_CREATE_SEQUENCE_STATEMENT,
	    	Postgres10PlusDdlLexicon.TYPE_CREATE_TRIGGER_STATEMENT,
	    	Postgres10PlusDdlLexicon.TYPE_GRANT_ON_SEQUENCE_STATEMENT,
	    	Postgres10PlusDdlLexicon.TYPE_GRANT_ON_SCHEMA_STATEMENT
	  	};
	    
	    public final static String[] COMPLEX_STMT_TYPES = {
	    	Postgres10PlusDdlLexicon.TYPE_CREATE_FUNCTION_STATEMENT
	    };
	}
	...
	interface PostgresDataTypes {
		...
		static final String[] DTYPE_MACADDR8 = {"MACADDR8"};
		...
		static final List<String[]> CUSTOM_DATATYPE_START_PHRASES = 
	  		Arrays.asList(DTYPE_BIGINT, DTYPE_BIGSERIAL, DTYPE_BOOL, DTYPE_BOOLEAN, DTYPE_BOX, DTYPE_BYTEA,
                            ...
                            DTYPE_LINE, DTYPE_LSEG, DTYPE_MACADDR, DTYPE_MACADDR8, DTYPE_MONEY, DTYPE_PATH, DTYPE_POINT, DTYPE_POLYGON,
