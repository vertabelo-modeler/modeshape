 ...
 *
 */
public class Postgres10PlusDdlLexicon extends StandardDdlLexicon {
    ...
    public static final String PARTITION_OF = Namespace.PREFIX + ":partitionOf";
    public static final String PARTITION_BOUND = Namespace.PREFIX + ":partitionBound";

    public static final String COLUMN_IDENTITY = Namespace.PREFIX + ":columnIdentity";
    public static final String COLUMN_IDENTITY_OPTIONS = Namespace.PREFIX + ":columnIdentityOptions";
    ...
    public static final String SEQ_DATA_TYPE       = Namespace.PREFIX + ":dataType";
}
